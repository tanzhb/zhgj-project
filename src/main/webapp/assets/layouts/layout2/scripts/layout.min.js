var Layout = function() {
    ...
    o = function() {
        ...
        if (s.hasClass("page-footer-fixed") === !0 && s.hasClass("page-sidebar-fixed") === !1) {
            ...
            if (s.hasClass("page-sidebar-fixed")) e = d(),
            s.hasClass("page-footer-fixed") === !1 && (e -= $(".page-footer").outerHeight());
            else {
                var n = $(".page-header").outerHeight(),
                r = $(".page-footer").outerHeight();
                e = App.getViewPort().width < i ? App.getViewPort().height - n - r: t.height() + 20,
                e + n + r <= App.getViewPort().height && (e = App.getViewPort().height - n - r)
            }
            a.css("min-height", e)
        }
    },
    ...
    r = function() {
        ...
        function(e) {
            ...
            if (! (App.getViewPort().width >= i && !$(".page-sidebar-menu").attr("data-initialized") && $("body").hasClass("page-sidebar-closed") && 1 === a.parent("li").parent(".page-sidebar-menu").size())) {
                ...
                if (! (App.getViewPort().width >= i && 1 === a.parents(".page-sidebar-menu-hover-submenu").size())) {
                    ...
                    var h = -200;
                    l.is(":visible") ? ($(".arrow", n).removeClass("open"), n.parent().removeClass("open"), l.slideUp(p,
                    function() {
                        d === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? r.slimScroll({
                            scrollTo: n.position().top
                        }) : App.scrollTo(n, h)),
                        o()
                    })) : t && ($(".arrow", n).addClass("open"), n.parent().addClass("open"), l.slideDown(p,
                    function() {
                        d === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? r.slimScroll({
                            scrollTo: n.position().top
                        }) : App.scrollTo(n, h)),
        ...
        function(e) {
            ...
            t = $(".page-sidebar ul");
            t.children("li.active").removeClass("active"),
            t.children("arrow.open").removeClass("open"),
            $(this).parents("li").each(function() {
                $(this).addClass("active"),
                $(this).children("a > span.arrow").addClass("open")
            }),
            $(this).parents("li").addClass("active"),
            App.getViewPort().width < i && $(".page-sidebar").hasClass("in") && $(".page-header .responsive-toggler").click(),
        ...
        function(e) {
            if (13 == e.which) return $(".sidebar-search").submit(),
            !1
        }),
    ...
    l = function() {
        ...
        function(e) {
            if (13 == e.which) return $(this).closest(".search-form").submit(),
            !1
        }),
    ...
    p = function() {
        ...
        0 === $(".page-sidebar-fixed").size() ? void o() : void(App.getViewPort().width >= i && (e.attr("data-height", d()), App.initSlimScroll(e), o()))
    },
    c = function() {
        var e = $("body");
    ...
    h = function() {
        ...
        function(a) {
            var i = $(".page-sidebar"),
            t = $(".page-sidebar-menu");
            $(".sidebar-search", i).removeClass("open"),
            e.hasClass("page-sidebar-closed") ? (e.removeClass("page-sidebar-closed"), t.removeClass("page-sidebar-menu-closed"), Cookies && Cookies.set("sidebar_closed", "0")) : (e.addClass("page-sidebar-closed"), t.addClass("page-sidebar-menu-closed"), e.hasClass("page-sidebar-fixed") && t.trigger("mouseleave"), Cookies && Cookies.set("sidebar_closed", "1")),
    ...
    f = function() {
        $(".full-height-content").each(function() {
            ...
            if (e = App.getViewPort().height - $(".page-header").outerHeight(!0) - $(".page-footer").outerHeight(!0) - $(".page-title").outerHeight(!0) - $(".page-bar").outerHeight(!0), a.hasClass("portlet")) {
                ...
                App.destroySlimScroll(t.find(".full-height-content-body")),
                e = e - a.find(".portlet-title").outerHeight(!0) - parseInt(a.find(".portlet-body").css("padding-top")) - parseInt(a.find(".portlet-body").css("padding-bottom")) - 2,
                App.getViewPort().width >= i && a.hasClass("full-height-content-scrollable") ? (e -= 35, t.find(".full-height-content-body").css("height", e), App.initSlimScroll(t.find(".full-height-content-body"))) : t.css("min-height", e)
            } else App.destroySlimScroll(a.find(".full-height-content-body")),
            App.getViewPort().width >= i && a.hasClass("full-height-content-scrollable") ? (e -= 35, a.find(".full-height-content-body").css("height", e), App.initSlimScroll(a.find(".full-height-content-body"))) : a.css("min-height", e)
        })
    };
    return {
        initHeader: function() {
