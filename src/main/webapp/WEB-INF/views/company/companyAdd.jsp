        ...
        <div class="portlet light">
            <div class="portlet-body">
				...
				<ul class="nav nav-tabs" id="companyTab">
					...
					<li class="bold"><a data-target="#tab_1_3" data-toggle="tab">联系人</a></li>
					<li class="bold"><a data-target="#tab_1_4" data-toggle="tab">财务信息</a></li>
				</ul>
                            ...
                            <form  id="companyForm" >
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="control-label bold" for="comType">企业类型 <span class="required"> * </span></label>
                                                    <div class="">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="control-label bold" for="comNature">企业性质 <span class="required"> * </span></label>
                                                    <div class="">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="control-label bold" for="legalPerson">企业法人姓名 <span class="required"> * </span></label>
                                                    <div class="">
										...
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="control-label bold" for="address">注册地址 <span class="required"> * </span></label>
                                                    <div class="">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="control-label bold" for="taxpayeNumber">纳税人识别号 <span class="required"> * </span></label>
                                                    <div class="">
                            ...
                            <form  id="companyForm" class="form-horizontal" >
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="col-md-4 control-label" for="comNum">企业编号 <span class="required"> * </span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="comNum" name="comNum" ng-model="company.comNum" ng-hide="companyAdd" >
                                                        <div class="form-control-focus"> </div>
                                                         <p class="control-label left" ng-show="companyView">{{company.comNum}}</p>
										...
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="col-md-4 control-label" for="comName">企业名称 <span class="required"> * </span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="comName"  name="comName" ng-model="company.comName" ng-hide="companyAdd" >
                                                        <div class="form-control-focus"> </div>
                                                         <p class="control-label left" ng-show="companyView">{{company.comName}}</p>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="col-md-4 control-label" for="comType">企业类型 <span class="required"> * </span></label>
                                                    <div class="col-md-8">
                                                         <select class="form-control" id="comType"  ng-hide="companyAdd" name="comType"  ng-model="company.comType" >
                                                            <option value=""></option>
                                                           	<option value="1" >采购商</option>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="col-md-4 control-label" for="comNature">企业性质 <span class="required"> * </span></label>
                                                    <div class="col-md-8">
                                                        <select class="form-control" id="comNature" ng-hide="companyAdd" name="comNature"  ng-model="company.comNature" >
                                                            <option value=""></option>
                                                           	<option value="国有企业" >国有企业</option>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="col-md-4 control-label" for="legalPerson">企业法人姓名 <span class="required"> * </span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="legalPerson" name="legalPerson" ng-model="company.legalPerson" ng-hide="companyAdd" >
                                                        <div class="form-control-focus"> </div>
                                                         <p class="control-label left" ng-show="companyView">{{company.legalPerson}}</p>
										...
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="col-md-4 control-label" for="address">注册地址 <span class="required"> * </span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="address" name="address" ng-model="company.address" ng-hide="companyAdd" >
                                                        <div class="form-control-focus"> </div>
                                                         <p class="control-label left" ng-show="companyView">{{company.address}}</p>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="col-md-4 control-label" for="taxpayeNumber">纳税人识别号 <span class="required"> * </span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="taxpayeNumber" name="taxpayeNumber" ng-model="company.taxpayeNumber" ng-hide="companyAdd" >
                                                        <div class="form-control-focus"> </div>
                                                         <p class="control-label left" ng-show="companyView">{{company.taxpayeNumber}}</p>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
                                                    <label class="col-md-4 control-label" for="contact">维护人员 <span class="required"> * </span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="contact" name="contact" ng-model="company.contact" ng-hide="companyAdd" >
                                                        <div class="form-control-focus"> </div>
                                                         <p class="control-label left" ng-show="companyView">{{company.contact}}</p>
