                                 ...
                                 <div class="control-label col-md-7" >
	                                 <p class="form-control-static"> {{buyOrder.tradeType}} </p>
											...
											<div class="form-group">
                                                    ...
                                                    <div class="control-label col-md-7">
                                                    <p class="form-control-static"   >{{stock.countInAmountSupply}}</p>
                                                    </div>
                                            </div>
										</div>
                                                            <div class="col-md-4">
                                                                ...
                                                                <label class="control-label col-md-4 bold" for="countOutAmount">累计出库数量 :</label>
                                                                    <div class="control-label col-md-7">
                                                          <p class="form-control-static"   >{{stock.countOutAmountSupply}}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                ...
                                                                <label class="control-label col-md-4 bold" for="lastInDate">最后入库日期 :</label>
                                                                    <div class="control-label col-md-7">
                                                           <p class="form-control-static"   >{{stock.lastInDateSupply}}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div><!-- row END-->
											...
											<div class="form-group">
                                                    ...
                                                    <div class="control-label col-md-7">
                                                          <p class="form-control-static"   >{{stock.lastOutDateSupply}}</p>
                                                    </div>
                                            </div>
										</div>
                                                            <div class="col-md-4">
