			...
			<div class="portlet-body">
				<div class="portlet light ">
					<div class="portlet-title">
						...
						<div class="tools" id="noprintdiv">
							...
							<button type="button"
								ng-click="goDelivery(deliveryDetail.serialNum)"
								...
								<tbody>
									<tr
										...
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.materielNum}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.materielName}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.specifications}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.unit}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.batchNum}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.manufactureDate}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.amount}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.deliverCount}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.remark}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.stockCount}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.unstockCount}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.warehouseName}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.positionName}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.stockRemark}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.qualifiedCount}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.unqualifiedCount}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.checkRemark}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.acceptCount}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.refuseCount}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.takeRemark}}</p></td>
										<td style="white-space: nowrap;"><p
												class="form-control-static">{{_deliveryMateriel.status}}</p></td>
									</tr>
								</tbody>
							</table>
						</div>
					...
					<div class="row">
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-11">
								<textarea class="form-control" ng-model="reason" id="reason"
									name="reason" rows="1"></textarea>
								<div class="form-control-focus"></div>
				...
				<form class="form-horizontal" id="applyAp_form">
					<div class="modal-footer">
						<button type="submit" ng-click="applyAp()" class="btn btn-primary">
