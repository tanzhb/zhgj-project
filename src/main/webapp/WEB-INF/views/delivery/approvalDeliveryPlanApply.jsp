					     ...
					     <div class="row">
	                          <div class="col-md-12">
	                          		<div class="form-group ">
		                                ...
		                                <div class="col-md-8">
	                                      <p class="form-control-static" > {{deliveryDetail.reason}} </p>
		                               	</div>
	                               </div>
	                          </div>
	                      </div>
		            ...
		            <div class="row">
						<div class="col-md-12">
							<div class="modal-footer">
								<button type="button" ng-click="deliverPass()" ng-hide="orderStatusInput" class="btn blue btn-circle  btn-sm">通过</button>
								<button type="button" ng-click="deliverUnPass()" ng-hide="orderStatusInput" class="btn red btn-circle  btn-sm">不通过</button>
				                <button type="button" ng-click="cancelPage()" class="btn default btn-circle  btn-sm"><i class="fa fa-undo"></i> 取消 </button>
							</div>
						</div>
					</div>
