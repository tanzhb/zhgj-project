				...
				<div class="portlet light ">
					...
					<div class="portlet-body form">
							<div class="table-scrollable">
								...
								<thead>
										<tr>
										    <th colspan='3' style="text-align:center;">收款方:中航国际</th>
											<th colspan='4' style="text-align:center;">付款方:{{pay.buyComId}}</th>
											<th colspan='4' style="text-align:center;">本次应收:<font color="red">{{pay.paymentAmount|currency:'￥'}}</font></th>
										</tr>
									</thead>
									<thead>
										<tr>
