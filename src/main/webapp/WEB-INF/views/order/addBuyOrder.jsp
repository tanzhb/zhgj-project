				                          ...
				                          <div class="col-md-4">
				                              <div class="form-group ">
				                                  ...
				                                  <div class="">
				                                        ...
				                                        <div class="form-control-focus"> </div>
				                              			<span class="help-block" ng-hide="buyOrderInput">请选择采购类型</span>
				                          ...
				                          <div class="col-md-4">
				                              <div class="form-group ">
				                                  ...
				                                  <div class="">
				                                        ...
				                                        <div class="form-control-focus"> </div>
				                              			<span class="help-block" ng-hide="buyOrderInput">请选择提货方式</span>
				                          ...
				                          <div class="col-md-4">
				                              <div class="form-group ">
				                                  ...
				                                  <div class="">
				                                      ...
				                                      <div class="form-control-focus"> </div>
				                                      <span class="help-block" ng-hide="buyOrderInput">请选择税率</span>
				                          ...
				                          <table class="table table-bordered table-hover">
				                              ...
				                              <tbody>
				                                  <tr ng-repeat="_orderMateriel in orderMateriel track by $index" ng-mouseover="showOperation('orderMateriel',$index)" ng-mouseleave="hideOperation('orderMateriel',$index)"  repeat-done="repeatDone(this)">
													  ...
													  <td ng-if="buyOrder.orderType =='标准采购(外贸)'">
													  		<p class="form-control-static" > {{(_orderMateriel.orderUnitPrice&&_orderMateriel.amount?_orderMateriel.orderUnitPrice*_orderMateriel.amount:0)*(_orderMateriel.customsRate/100)}} </p>
													  </td>
