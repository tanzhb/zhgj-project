...
<div class="tabbable-line">
    <ul class="nav nav-tabs">
        <li class="active">
            <a data-target="#tab_15_1" data-toggle="tab">入库检验</a>
        </li>
        <li>
            <a data-target="#tab_15_2" data-toggle="tab">出库检验</a>
        </li>
    </ul>
			        ...
			        <!-- BEGIN EXAMPLE TABLE PORTLET-->
			                <div class="portlet box blue">
			                                <div class="portlet-title">
												<div class="caption">
													<i class="fa fa-globe"></i>入库检验
												</div>
												<div class="actions">
													<a href="javascript:;" class="btn btn-default btn-sm btn-circle"
														ng-click="addCheckIn()"> <i class="fa fa-plus"></i> 添加
													</a>  <a href="javascript:;" class="btn btn-default btn-sm btn-circle"
														ng-click="toEditCheckIn()"> <i class="fa fa-edit"></i> 修改
													</a> <a href="javascript:;" class="btn btn-default btn-sm btn-circle"
														ng-click="deleteCheckIn()"> <i class="fa fa-minus"></i>
														删除  
													</a>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-right" id="sample_3_tools">
															...
															<li><a href="javascript:;" data-action="1"
																class="tool-action" ng-click="exportCheckIn()"> <i
