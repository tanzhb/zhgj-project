...
<!-- <h3 class="page-title d_tip"> 新建供应商对账单
</h3> -->
<!-- <div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a ui-sref="statement">供应商对账单</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
            <a class="d_tip">新建供应商对账单</a>
        </li>
    </ul>
				...
				<div class="portlet light ">
					...
					<!-- 基本信息START -->
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                              <!--   <button   ng-show="statementView" class="btn blue  btn-outline  btn-sm " ng-click="editstatement()">
                                ...
                                <button   class="btn green  btn-sm btn-circle" ng-click="saveSupplyStatement()">
                              		<i class="fa fa-check"></i> 确认发送 </button>
                      			<button    class="btn defualt  btn-sm btn-circle" ng-click="cancelSupplyStatement()" onclick="return false;">
                        ...
                        <div class="portlet-body form">
								<div class="form-body">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <select class="form-control" selectpicker  data-live-search="true"  id="supplyComId" ng-change="getOrderRecords()"  name="supplyComId" ng-model="statement.supplyComId" ng-hide="statementAdd"  data-size="8">
	                                                        <option value=""></option>
										...
										<div class="col-md-4">
											<div class="form-group" id="statementDateDiv">
                                                    ...
                                                    <div class="">
	                                                        <input type="text" class="form-control date-picker"  data-date-format="yyyy-mm-dd" id="statementDate" name="statementDate" ng-model="statement.statementDate" ng-hide="statementAdd" readonly>
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
                                                    <label class="control-label bold" for="supplyComId">期初应付</label>
                                                    <div class="">
										...
										<div class="col-md-4">
											<div class="form-group">
                                                    <label class="control-label bold" for="shipper">本期应付</label>
                                                    <div class="">
                                                       <!--  <input type="text" class="form-control" id="shipper"  name="shipper" ng-model="statement.shipper" ng-hide="statementAdd" > -->
                                                        <div class="form-control-focus"> </div>
										...
										<div class="col-md-4">
											<div class="form-group">
                                                    <label class="control-label bold" for="receiver">本期已付</label>
                                                    <div class="">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
                                                    <label class="control-label bold" for="maker">期末应付</label>
                                                    <div class="">
											...
											<div class="form-group">
                                                    ...
                                                    <div class="">
	                                                    <input type="text" class="form-control date-picker"  data-date-format="yyyy-mm-dd" id="makeDate" name="makeDate" ng-model="statement.makeDate" ng-hide="statementAdd"  readonly>
                                                         ...
                                                         --><div class="form-control-focus"> </div>
                                                         <p class="control-label left" ng-show="statementView">{{statement.makeDate}}</p>
                                                    </div>
                                            </div>
										</div>
										<!--/span-->
         			...
         			<ul class="nav nav-tabs" id="statementy_tab">
				        <li class="active">
				            <a data-target="#tab_15_1" data-toggle="tab" class="bold">本期应付</a>
				        </li>
				        <li>
				            <a data-target="#tab_15_2" data-toggle="tab" class="bold">本期已付</a>
				        </li>
				        <!-- <li>
					...
					<div class="tab-content">
         			...
         			<!-- <div class="row">
         				...
         				<div class="col-md-1">
         					 <button   ng-hide="statementAdd" class="btn blue" ng-click="saveSupplyStatement()">
                                            <i class="fa fa-check"></i>确认发送</button>
         				</div>
         				<div class="col-md-1">
         					 <button   ng-hide="statementAdd" class="btn red btn-outline" ng-click="cancelSupplyStatement()" onclick="return false;">
                                            <i class="fa fa-undo"></i>取消</button>
         				</div>
         				<div class="col-md-5"></div>
         			</div> -->
