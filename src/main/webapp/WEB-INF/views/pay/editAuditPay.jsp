		...
		<div class="portlet bordered">
			<div class="portlet-body">
					...
					<div class="portlet light ">
						...
						<div class="tab-pane fade active in" id="tab_1_1">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="">
														<input type="text" name="paymentNum" class="form-control"
															ng-model="pay.paymentNum" ng-show="input">
														<div class="form-control-focus"></div>
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-md-10">
														...
														<div class="form-control-focus"></div>
														<p class="form-control-static" ng-show="span">{{pay.reason}}</p>
							...
							<div class="tab-pane fade" id="tab_1_3">
								<div class="portlet-title" style="min-height: 48px;">
									<div class="tools" style="float: right" id="noprintdiv">
										<button type="submit" ng-click="updateFile()"
				...
				<!-- <div class="modal-footer">
					<button type="submit" ng-click="apApplyAngain()"
						class="btn blue">
						<i class="glyphicon glyphicon-plane"></i> 重新申请
					</button>
					<button type="submit" ng-click="apCancelApply()"
						class="btn red">
						<i class="glyphicon glyphicon-ban-circle"></i> 取消申请
					</button>					
				...
				<div class="portlet-title">
			               <div class="tools">
			               		<button type="button" ng-click="apApplyAngain()"  class="btn blue btn-circle  btn-sm">重新申请</button>
			               		<button type="button" ng-click="apCancelApply()" class="btn red btn-circle  btn-sm">取消申请</button>
