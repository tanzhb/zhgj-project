												...
												<div class="form-group">
													<label class="control-label bold">关联清关单号<span
														...
														<div class="input-group" data-target="#basicBgInfo"
															...
															onclick="return false;">
															<input id="orderSerial1" name="qgOrBgNum" type="text" ng-show="input"
																class="form-control" ng-model="saleOrder.orderNum"
																readonly="readonly"> <span
																class="input-group-btn" ng-show="input" style="vertical-align: top;">
																<button class="btn default" type="button">
			...
			<div class="table-scrollable">
				<table id="verificationRecordTable"
					...
					<tfoot>
													<tr>
														<td></td>
														<td style="text-align: center">应付账单金额:{{calcTotalData()}} {{paymentRecord.applyPaymentAmount|currency:''}}</td>
...
<jsp:include page="selectPayMemo.jsp"></jsp:include>
