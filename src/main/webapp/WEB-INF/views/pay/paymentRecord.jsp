	...
	<div class="col-md-12">
		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>付款列表
				</div>
				<!-- <div class="actions" ng-controller='MyCtrl'>
					<a href="javascript:;" ng-click="jumpToUrl('addPay')"
						class="btn btn-default btn-sm btn-circle"> <i
						class="fa fa-plus"></i> 添加
					</a> <a href="javascript:;" ng-click="jumpToEdit()"
						class="btn btn-default btn-sm btn-circle"> <i
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right" id="sample_3_tools">
							...
							<li><a href="javascript:;" data-action="0"
								class="tool-action" ng-click="exportPay()"> <i
				...
				<div class="actions" ng-controller='MyCtrl' id="buttons">
					<label class="btn btn-transparent green btn-circle btn-sm"
						ng-click="jumpToApplyPay()"><i class="fa fa-plus"></i> 申请</label>
					<label class="btn btn-transparent green btn-circle btn-sm"
						ng-click="jumpToUrl('addPay')"><i class="fa fa-plus"></i>
						添加</label> <label class="btn btn-transparent purple btn-circle btn-sm"
						...
						ng-click="exportPay()"> <i class="fa fa-file-excel-o"></i>
						导出
					</label>
				</div>
			</div>
