										...
										<div class="col-md-4">
											<div class="form-group">
                                                    <label class="control-label bold" for="inOutType">入库类型 <span class="required"> * </span></label>
	                                                 <div class="">
	                                                 	<select class="form-control"  name="inOutType" ng-change="changeStockInMode(record.inOutType)" ng-model="record.inOutType" ng-init="record.inOutType='贸易'"   data-size="8">
			                                                   <!-- <option value=""></option> -->
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
                                                    ...
                                                    <div class="">
                                                       <input  ng-if="!otherMode" type="text" class="form-control"  value="{{shipperOrReceiver}}" disabled="disabled">
							...
							<table id="deliveryMaterielTable" ng-if="!otherMode"
								...
								<tbody data-repeater-list="group-a"> 
									<tr data-repeater-item ng-repeat="materiel in takeDeliveryMateriels track by materiel.serialNum" repeat-done="setDefualtNum(this)">
										...
										<td>
											<div class="col-md-12 form-group"><!--  class="bs-select form-control order"  class="bs-select form-control warehouseSerial"  -->
                                                <select ng-if="$first"  data-live-search="true"   class="form-control input-small" ng-init="warehouses[0].serialNum" ng-change="getPositionsAndSelectedAll(materiel)"  name="warehouseSerial" ng-model="materiel.warehouseSerial"  data-size="8">
	                                                 <!--  <option value=""></option> -->
	                                            ...
	                                            <select ng-if="!$first" class="form-control input-small" data-live-search="true"   ng-init="warehouses[0].serialNum" ng-change="getPositions(materiel)"  name="warehouseSerial" ng-model="materiel.warehouseSerial"  data-size="8">
	                                                 <!--  <option value=""></option> -->
	                                                  <option  class="{{materiel.serialNum}}"   ng-repeat="warehouse in warehouses"    value="{{warehouse.serialNum}}">{{warehouse.warehouseName}}</option>
	                                            </select>
	                                            <div class="form-control-focus"></div>
										...
										<td>
											<div class="col-md-12"><!-- class="bs-select form-control order"  -->
							...
							<table id="deliveryMaterielTable" ng-if="otherMode"
								...
								<tbody data-repeater-list="group-a"> 
									<tr data-repeater-item ng-repeat="materiel in takeDeliveryMateriels track by materiel.serialNum" repeat-done="setDefualtNum(this)">
										...
										<td>
											<div class="col-md-12 form-group">
                                                 <input type="text" class="form-control input-small" id="stockCount{{$index}}" ng-model="materiel.stockCount" ng-hide="deliverAdd" >
                                                 <div class="form-control-focus"> </div>
                                            </div>
										</td>
										<td>
											<div class="col-md-12 form-group">
	                                            ...
	                                            <select ng-if="!$first" class="bs-select form-control warehouseSerial" data-live-search="true"   ng-init="warehouses[0].serialNum" ng-change="getPositions(materiel)"  name="warehouseSerial" ng-model="materiel.warehouseSerial"  data-size="8">
	                                                 <!--  <option value=""></option> -->
	                                                  <option   class="{{materiel.serialNum}}" ng-repeat="warehouse in warehouses" value="{{warehouse.serialNum}}">{{warehouse.warehouseName}}</option>
	                                            </select>
	                                            <div class="form-control-focus"></div>
