    ...
    <div class="col-md-12">
        <!-- BEGIN EXAMPLE TABLE PORTLET-->
			<div class="portlet light ">
					...
					<jsp:include  page="addProcurementPlan.jsp"/>
      			</div>
      			   <div class="row">
						<div class="col-md-12">
							<p>
      			...
      			<!-- //申请原因 -->
			                      ...
			                      <div class="row">
			                          <div class="col-md-8">
			                          		<div class="form-group ">
				                                ...
				                                <div class="">
				                                  <input type="text" name="reason" class="form-control"  ng-model="procurementPlan.reason"  >
		            ...
		            <div class="portlet-title">
			               <div class="tools">
			               		<button type="button" ng-click="replyProcurementPlan()" ng-hide="orderStatusInput" class="btn blue btn-circle  btn-sm">重新申请</button>
