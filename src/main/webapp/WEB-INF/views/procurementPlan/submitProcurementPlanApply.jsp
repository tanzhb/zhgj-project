    ...
    <div class="col-md-12">
        <!-- BEGIN EXAMPLE TABLE PORTLET-->
			<div class="portlet light ">
			                      ...
			                      <div class="row">
			                          <div class="col-md-8">
			                          		<div class="form-group ">
				                                ...
				                                <div class="">
				                                  <input type="text" name="remark"  class="form-control"  ng-model="procurementPlan.reason"  >
		            ...
		            <div class="portlet-title">
			               <div class="tools">
			               		<button type="button" ng-click="confirmProcurementPlanApply()" ng-hide="orderStatusInput" class="btn blue btn-circle  btn-sm">提交申请</button>
				                <button type="button" ng-click="cancelPage()" class="btn default btn-circle  btn-sm"><i class="fa fa-undo"></i> 取消 </button>
				            </div>
					</div>
      			</div>
