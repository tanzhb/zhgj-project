        ...
        <!-- BEGIN EXAMPLE TABLE PORTLET-->
			<div class="portlet light ">
      			...
      			<!-- //申请原因 -->
			                      ...
			                      <div class="row">
			                          <div class="col-md-8">
			                          		<div class="form-group ">
				                                ...
				                                <div class="">
				                                  <input type="text" name="reason" class="form-control"  ng-model="invoice.reason">
		            ...
		            <div class="portlet-title">
			               <div class="tools">
			               		<button type="button" ng-click="replyInvoice()"   class="btn blue btn-circle  btn-sm">重新申请</button>
			               		<button type="button" ng-click="cancelApplyInvoice()"    class="btn red btn-circle  btn-sm">取消申请</button>
				                <button type="button" ng-click="cancelPage()" class="btn default btn-circle  btn-sm"><i class="fa fa-undo"></i> 取消 </button>
				            </div>
					</div>
			</div>
