...
public class CustomsFormControlller {
    ...
    public void exportWarehouse(Map<String, Object> map,HttpServletRequest request,HttpServletResponse response,String type) {
    		Map<String, Object> dataMap = new HashMap<String, Object>();
    		List<CustomsForm> customsFormList = customsFormService.selectCustomsFormList(type);
          for(CustomsForm customsForm:customsFormList){
    		...
    		if("clearance".equals(type)){
    			ExcelUtil.export(request, response, dataMap, "customsform"+type, "清关单信息");
    		}else if("declaration".equals(type)){
    			ExcelUtil.export(request, response, dataMap, "customsform"+type, "报关单信息");
    		}
    ...
    public void downloadCustomsFormTemp(Map<String, Object> map,HttpServletRequest request,HttpServletResponse response,String type) {
    ...
    @ResponseBody
    public Map<String,String> companyImport(@RequestParam(value = "excelFile") MultipartFile excelFile,HttpServletRequest request,HttpServletResponse response,@RequestParam(value = "type") String type) {
